...
const Faq = () => {
  return (
    <div
      id="faq"
      className="min-h-screen z-20 flex flex-col justify-center items-center pt-[10px] max-sm:pt-[20px] px-[40px] max-sm:px-[27px]"
    >
      <h1
      ...
      {FaqData.map((data, i) => (
        <div className="mb-[10px] sm:mb-[16px] whitespace-pre-line"  key={i}>
